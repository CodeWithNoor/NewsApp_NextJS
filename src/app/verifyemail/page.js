        ...
        <div className="container" id="emailverified">
            ...
            {verified && (
                <div className="d-flex flex-column align-items-center justify-content-center mt-5">
                    <h5 className="text-black">Your email verification has been successfully  now click login</h5>
                    <Link href="/userlogin" className="bg-black text-white py-3 px-4 text-decoration-none my-3"> Login </Link>
                </div>
            )}
            {error && (
